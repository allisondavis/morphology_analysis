...
reg.lat.D.plot
ggsave(reg.lat.D.plot, filename = "reg.lat.D.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.P1.plot
ggsave(reg.lat.P1.plot, filename = "reg.lat.P1.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.A.plot
ggsave(reg.lat.A.plot, filename = "reg.lat.A.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.P1.R.plot
ggsave(reg.lat.P1.R.plot, filename = "reg.lat.P1-R.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.LLSC.plot
ggsave(reg.lat.LLSC.plot, filename = "reg.lat.LLSC.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.SALL.plot
ggsave(reg.lat.SALL.plot, filename = "reg.lat.SALL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.SBLL.plot
ggsave(reg.lat.SBLL.plot, filename = "reg.lat.SBLL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.SBDF.plot
ggsave(reg.lat.SBDF.plot, filename = "reg.lat.SBDF.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.BD.plot
ggsave(reg.lat.BD.plot, filename = "reg.lat.BD.plot.png", bg="transparent", width = 95, height = 90, units = "mm", dpi = 300)
reg.lat.CPD.plot
ggsave(reg.lat.CPD.plot, filename = "reg.lat.CPD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.CPL.plot
ggsave(reg.lat.CPL.plot, filename = "reg.lat.CPL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.PreDL.plot
ggsave(reg.lat.PreDL.plot, filename = "reg.lat.PreDL.plot.png", bg="transparent", width = 95, height = 90, units = "mm", dpi = 300)
reg.lat.DbL.plot
ggsave(reg.lat.DbL.plot, filename = "reg.lat.DbL.plot.png", bg="transparent", width = 95, height = 90, units = "mm", dpi = 300)
reg.lat.HL.plot
ggsave(reg.lat.HL.plot, filename = "reg.lat.HL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.HD.plot
ggsave(reg.lat.HD.plot, filename = "reg.lat.HD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.HW.plot
ggsave(reg.lat.HW.plot, filename = "reg.lat.HW.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.SnL.plot
ggsave(reg.lat.SnL.plot, filename = "reg.lat.SnL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.OL.plot
ggsave(reg.lat.OL.plot, filename = "reg.lat.OL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.lat.FLA.plot
ggsave(reg.lat.FLA.plot, filename = "reg.lat.FLA.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
...
reg.form.D.plot
ggsave(reg.form.D.plot, filename = "reg.form.D.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.P1.plot
ggsave(reg.form.P1.plot, filename = "reg.form.P1.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.A.plot
ggsave(reg.form.A.plot, filename = "reg.form.A.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.P1.R.plot
ggsave(reg.form.P1.R.plot, filename = "reg.form.P1-R.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.LLSC.plot
ggsave(reg.form.LLSC.plot, filename = "reg.form.LLSC.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.SALL.plot
ggsave(reg.form.SALL.plot, filename = "reg.form.SALL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.SBLL.plot
ggsave(reg.form.SBLL.plot, filename = "reg.form.SBLL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.SBDF.plot
ggsave(reg.form.SBDF.plot, filename = "reg.form.SBDF.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.BD.plot
ggsave(reg.form.BD.plot, filename = "reg.form.BD.plot.png", bg="transparent", width = 95, height = 90, units = "mm", dpi = 300)
reg.form.CPD.plot
ggsave(reg.form.CPD.plot, filename = "reg.form.CPD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.CPL.plot
ggsave(reg.form.CPL.plot, filename = "reg.form.CPL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.PreDL.plot
ggsave(reg.form.PreDL.plot, filename = "reg.form.PreDL.plot.png", bg="transparent", width = 95, height = 90, units = "mm", dpi = 300)
reg.form.DbL.plot
ggsave(reg.form.DbL.plot, filename = "reg.form.DbL.plot.png", bg="transparent", width = 95, height = 90, units = "mm", dpi = 300)
reg.form.HL.plot
ggsave(reg.form.HL.plot, filename = "reg.form.HL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.HD.plot
ggsave(reg.form.HD.plot, filename = "reg.form.HD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.HW.plot
ggsave(reg.form.HW.plot, filename = "reg.form.HW.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.SnL.plot
ggsave(reg.form.SnL.plot, filename = "reg.form.SnL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.OL.plot
ggsave(reg.form.OL.plot, filename = "reg.form.OL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
reg.form.FLA.plot
ggsave(reg.form.FLA.plot, filename = "reg.form.FLA.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
...
rownames(average.table) <- c("dorsal rays", "L pect rays", "R pelvic rays*", "L pelvic rays*", "Anal rays", "R pect rays*", "lat line scales", "scalesabove LL", "scalesbelow LL", "scalesbefore dor*", "body dep", "peduncle dep", "peduncle leng", "pre-dorsal", "dorsal base", "head length", "head depth", "head width", "snout leng", "orbital leng", "fluct. asymmetries")
...
Tplot1<- autoplot(PCA.MX, x=2, y=3, data = rawMX, colour='SPP', loadings=FALSE, loadings.label=FALSE, frame=TRUE, frame.type='norm')+scale_color_manual(values=c("#E1AF00","#78B7C5", "#9986A5"))+ scale_fill_manual(values=c("#E1AF00","#78B7C5", "#9986A5"))+  ggtitle("PCA Plot of Morphology traits") + theme_minimal() 
Tplot1

ggsave(Tplot1, filename = "T-pc1v2.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)

Tplot2<- autoplot(PCA.MX, data = rawMX, colour='SPP', loadings=FALSE, loadings.label=FALSE, frame=TRUE, frame.type='norm')+scale_color_manual(values=c("#E1AF00","#78B7C5",  "#9986A5"))+ scale_fill_manual(values=c("#E1AF00","#78B7C5",  "#9986A5"))+  ggtitle("PCA Plot of Morphology traits") + theme_minimal() 
Tplot2

ggsave(Tplot2, filename = "T-pc2v3.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)
...
**Quick results summary:** traits *not* influenced by body size are left & right pelvic, anal, scalesabove and below lateral line (except in mexicana), scalesbefore dorsal fin and fluctuating asymmetry; all other traits influenced by body size.
...
F.reg.lat.CPD.plot <- ggplot(lat.F, aes(x = SL_log, y = CPD_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#78B7C5") +
  stat_cor(label.y = 1.2,  size=5) + theme_bw() + labs(x= "\n Standard length (mm, log transformed)", y="Depth (mm, log transformed)\n")
F.reg.lat.CPD.plot
...
F.reg.lat.PreDL.plot <- ggplot(lat.F, aes(x = SL_log, y = PreDL_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#78B7C5") +
  stat_cor(label.y = 1,  size=5) + theme_bw() + labs(x= "\n Standard length (mm, log transformed)", y="Length (mm, log transformed)\n")
...
F.reg.lat.DbL.plot <- ggplot(lat.F, aes(x = SL_log, y = DbL_log)) + 
  geom_point() +
  stat_smooth(method = "lm", ccol = "#78B7C5") +
  stat_cor(label.y = 1,  size=5) + theme_bw() + labs(x= "\n Standard length (mm, log transformed)", y="Length (mm, log transformed)\n")
F.reg.lat.DbL.plot
...
F.reg.lat.HL.plot <- ggplot(lat.F, aes(x = SL_log, y = HL_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#78B7C5") +
  stat_cor(label.y = 1.4,  size=5) + theme_bw() + labs(x= "\n Standard length (mm, log transformed)", y="Length (mm, log transformed)\n")
F.reg.lat.HL.plot
...
F.reg.lat.HW.plot <- ggplot(lat.F, aes(x = SL_log, y = HW_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#78B7C5") +
  stat_cor(label.y = 1.3,  size=5) + theme_bw() + labs(x= "\n Standard length (mm, log transformed)", y="Width (mm, log transformed)\n")
F.reg.lat.HW.plot
...
F.reg.lat.D.plot
ggsave(F.reg.lat.D.plot, filename = "F.reg.lat.D.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.P1.plot
ggsave(F.reg.lat.P1.plot, filename = "F.reg.lat.P1.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.A.plot
ggsave(F.reg.lat.A.plot, filename = "F.reg.lat.A.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.P1.R.plot
ggsave(F.reg.lat.P1.R.plot, filename = "F.reg.lat.P1-R.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.LLSC.plot
ggsave(F.reg.lat.LLSC.plot, filename = "F.reg.lat.LLSC.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.SALL.plot
ggsave(F.reg.lat.SALL.plot, filename = "F.reg.lat.SALL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.SBLL.plot
ggsave(F.reg.lat.SBLL.plot, filename = "F.reg.lat.SBLL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.SBDF.plot
ggsave(F.reg.lat.SBDF.plot, filename = "F.reg.lat.SBDF.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.BD.plot
ggsave(F.reg.lat.BD.plot, filename = "F.reg.lat.BD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.CPD.plot
ggsave(F.reg.lat.CPD.plot, filename = "F.reg.lat.CPD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.CPL.plot
ggsave(F.reg.lat.CPL.plot, filename = "F.reg.lat.CPL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.PreDL.plot
ggsave(F.reg.lat.PreDL.plot, filename = "F.reg.lat.PreDL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.DbL.plot
ggsave(F.reg.lat.DbL.plot, filename = "F.reg.lat.DbL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.HL.plot
ggsave(F.reg.lat.HL.plot, filename = "F.reg.lat.HL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.HD.plot
ggsave(F.reg.lat.HD.plot, filename = "F.reg.lat.HD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.HW.plot
ggsave(F.reg.lat.HW.plot, filename = "F.reg.lat.HW.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.SnL.plot
ggsave(F.reg.lat.SnL.plot, filename = "F.reg.lat.SnL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.OL.plot
ggsave(F.reg.lat.OL.plot, filename = "F.reg.lat.OL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.lat.FLA.plot
ggsave(F.reg.lat.FLA.plot, filename = "F.reg.lat.FLA.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
...
F.reg.form.D.plot <- ggplot(form.F, aes(x =SL, y = D)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 10, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Number of rays\n")
F.reg.form.D.plot
...
F.reg.form.P1.plot <- ggplot(form.F, aes(x = SL, y = P1)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 12, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Number of rays\n")
F.reg.form.P1.plot
...
F.reg.form.A.plot <- ggplot(form.F, aes(x = SL, y = A)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 8.7, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Number of rays\n")
F.reg.form.A.plot
...
F.reg.form.SBDF.plot <- ggplot(form.F, aes(x = SL, y = SBDF)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 6.5, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Number of scales\n")
...
F.reg.form.BD.plot <- ggplot(form.F, aes(x = SL_log, y = BD_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 1.5, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Depth (mm, log transformed) \n")
F.reg.form.BD.plot
...
F.reg.form.CPL.plot <- ggplot(form.F, aes(x = SL_log, y = CPL_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 1.2, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Length (mm, log transformed) \n")
F.reg.form.CPL.plot
...
F.reg.form.HD.plot <- ggplot(form.F, aes(x = SL_log, y = HD_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 1.25, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Depth (mm, log transformed) \n")
F.reg.form.HD.plot
...
F.reg.form.HW.plot <- ggplot(form.F, aes(x = SL_log, y = HW_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 1.3, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Width (mm, log transformed) \n")
F.reg.form.HW.plot
...
F.reg.form.SnL.plot <- ggplot(form.F, aes(x = SL_log, y = SnL_log)) + 
  geom_point() +
  stat_smooth(method = "lm", col = "#E1AF00") +
  stat_cor(label.y = 1.6, size=5)+ theme_bw() + labs(x= "\n Standard length (mm)", y="Length (mm, log transformed) \n")
F.reg.form.SnL.plot
...
F.reg.form.D.plot
ggsave(F.reg.form.D.plot, filename = "F.reg.form.D.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.P1.plot
ggsave(F.reg.form.P1.plot, filename = "F.reg.form.P1.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.A.plot
ggsave(F.reg.form.A.plot, filename = "F.reg.form.A.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.P1.R.plot
ggsave(F.reg.form.P1.R.plot, filename = "F.reg.form.P1-R.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.LLSC.plot
ggsave(F.reg.form.LLSC.plot, filename = "F.reg.form.LLSC.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.SALL.plot
ggsave(F.reg.form.SALL.plot, filename = "F.reg.form.SALL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.SBLL.plot
ggsave(F.reg.form.SBLL.plot, filename = "F.reg.form.SBLL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.SBDF.plot
ggsave(F.reg.form.SBDF.plot, filename = "F.reg.form.SBDF.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.BD.plot
ggsave(F.reg.form.BD.plot, filename = "F.reg.form.BD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.CPD.plot
ggsave(F.reg.form.CPD.plot, filename = "F.reg.form.CPD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.CPL.plot
ggsave(F.reg.form.CPL.plot, filename = "F.reg.form.CPL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.PreDL.plot
ggsave(F.reg.form.PreDL.plot, filename = "F.reg.form.PreDL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.DbL.plot
ggsave(F.reg.form.DbL.plot, filename = "F.reg.form.DbL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.HL.plot
ggsave(F.reg.form.HL.plot, filename = "F.reg.form.HL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.HD.plot
ggsave(F.reg.form.HD.plot, filename = "F.reg.form.HD.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.HW.plot
ggsave(F.reg.form.HW.plot, filename = "F.reg.form.HW.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.SnL.plot
ggsave(F.reg.form.SnL.plot, filename = "F.reg.form.SnL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.OL.plot
ggsave(F.reg.form.OL.plot, filename = "F.reg.form.OL.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
F.reg.form.FLA.plot
ggsave(F.reg.form.FLA.plot, filename = "F.reg.form.FLA.plot.png", bg="transparent", width = 90, height = 90, units = "mm", dpi = 300)
...
plotF1<- autoplot(PCA.F, data = rawFa, colour='SPP', loadings=FALSE, loadings.label=FALSE, frame=TRUE, frame.type='norm')+scale_color_manual(values=c("#E1AF00","#78B7C5"))+ scale_fill_manual(values=c("#E1AF00","#78B7C5"))+ ggtitle("PCA Plot of Morphology traits") + theme_minimal() 
plotF1

ggsave(plotF1, filename = "F-pc1v2.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)
...
plotF5<- autoplot(PCA.F, x=2, y=3, data = rawFa, colour='SPP', loadings=FALSE, loadings.label=FALSE, frame=TRUE, frame.type='norm')+scale_color_manual(values=c("#E1AF00","#78B7C5"))+ scale_fill_manual(values=c("#E1AF00","#78B7C5"))+ ggtitle("PCA Plot of Morphology traits") + theme_minimal()
plotF5

ggsave(plotF5, filename = "F-pc2v3.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)
...
TplotF1<- autoplot(FPCA.MX, x=2, y=3, data = FrawMX, colour='SPP', loadings=FALSE, loadings.label=FALSE, frame=TRUE, frame.type='norm')+scale_color_manual(values=c("#E1AF00","#78B7C5", "#9986A5"))+ scale_fill_manual(values=c("#E1AF00","#78B7C5", "#9986A5"))+ ggtitle("PCA Plot of Morphology traits") + theme_minimal() 
TplotF1

ggsave(TplotF1, filename = "TF-pc1v2.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)

TplotF2<- autoplot(FPCA.MX, data = FrawMX, colour='SPP', loadings=FALSE, loadings.label=FALSE, frame=TRUE, frame.type='norm')+scale_color_manual(values=c("#E1AF00","#78B7C5", "#9986A5"))+ scale_fill_manual(values=c("#E1AF00","#78B7C5", "#9986A5"))+ ggtitle("PCA Plot of Morphology traits") + theme_minimal() 
TplotF2

ggsave(TplotF2, filename = "TF-pc2v3.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)
...
D <- ggplot(raw3, aes(x=SPP, y=D, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  +stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=D), fun=mean, geom="point", colour= "#29211F", size=2)

P1 <- ggplot(raw3, aes(x=SPP, y=P1, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=P1), fun=mean, geom="point", colour= "#29211F", size=2)

A <- ggplot(raw3, aes(x=SPP, y=A, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)+ theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=A), fun=mean, geom="point", colour= "#29211F", size=2)

P1.R <- ggplot(raw3, aes(x=SPP, y=P1.R, color=SPP)) + scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=P1.R), fun=mean, geom="point", colour= "#29211F", size=2)


LLSC <- ggplot(raw3, aes(x=SPP, y=LLSC, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of scales  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=LLSC), fun=mean, geom="point", colour= "#29211F", size=2)

SALL <- ggplot(raw3, aes(x=SPP, y=SALL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Number of scales  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SALL), fun=mean, geom="point", colour= "#29211F", size=2)

SBLL <- ggplot(raw3, aes(x=SPP, y=SBLL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)+ theme_classic()+ ylab("Number of scales  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SBLL), fun=mean, geom="point", colour= "#29211F", size=2)  

SBDF <- ggplot(raw3, aes(x=SPP, y=SBDF, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of scales  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SBDF), fun=mean, geom="point", colour= "#29211F", size=2)

BD <- ggplot(raw3, aes(x=SPP, y=BD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=BD), fun=mean, geom="point", colour= "#29211F", size=2)

CPD <- ggplot(raw3, aes(x=SPP, y=CPD, color=SPP)) + scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=CPD), fun=mean, geom="point", colour= "#29211F", size=2)


CPL <- ggplot(raw3, aes(x=SPP, y=CPL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=CPL), fun=mean, geom="point", colour= "#29211F", size=2)

PreDL <- ggplot(raw3, aes(x=SPP, y=PreDL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=PreDL), fun=mean, geom="point", colour= "#29211F", size=2)  

DbL <- ggplot(raw3, aes(x=SPP, y=DbL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=DbL), fun=mean, geom="point", colour= "#29211F", size=2)

HL <- ggplot(raw3, aes(x=SPP, y=HL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HL), fun=mean, geom="point", colour= "#29211F", size=2) 

HD <- ggplot(raw3, aes(x=SPP, y=HD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HD), fun=mean, geom="point", colour= "#29211F", size=2)

HW <- ggplot(raw3, aes(x=SPP, y=HW, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Width (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HW), fun=mean, geom="point", colour= "#29211F", size=2)

SnL <- ggplot(raw3, aes(x=SPP, y=SnL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SnL), fun=mean, geom="point", colour= "#29211F", size=2)

OL <- ggplot(raw3, aes(x=SPP, y=OL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=OL), fun=mean, geom="point", colour= "#29211F", size=2)

FLA <- ggplot(raw3, aes(x=SPP, y=FLA, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Pectoral ray count difference \n (fluctuating asymmetries)\n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=FLA), fun=mean, geom="point", colour= "#29211F", size=2)
  

D
ggsave(D, filename = "D.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
P1
ggsave(P1, filename = "P1.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
A
ggsave(A, filename = "A.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
P1.R
ggsave(P1.R, filename = "P1-R.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
LLSC
ggsave(LLSC, filename = "LLSC.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
SALL
ggsave(SALL, filename = "SALL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
SBLL
ggsave(SBLL, filename = "SBLL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
SBDF
ggsave(SBDF, filename = "SBDF.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
BD
ggsave(BD, filename = "BD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
CPD
ggsave(CPD, filename = "CPD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
CPL
ggsave(CPL, filename = "CPL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
PreDL
ggsave(PreDL, filename = "PreDL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
DbL
ggsave(DbL, filename = "DbL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
HL
ggsave(HL, filename = "HL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
HD
ggsave(HD, filename = "HD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
HW
ggsave(HW, filename = "HW.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
SnL
ggsave(SnL, filename = "SnL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
OL
ggsave(OL, filename = "OL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
FLA
ggsave(FLA, filename = "FLA.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
```
...
T.D <- ggplot(tampico, aes(x=SPP, y=D, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2,width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of rays  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=D), fun=mean, geom="point", colour= "#29211F", size=2)

T.P1 <- ggplot(tampico, aes(x=SPP, y=P1, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=P1), fun=mean, geom="point", colour= "#29211F", size=2)

T.A <- ggplot(tampico, aes(x=SPP, y=A, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=A), fun=mean, geom="point", colour= "#29211F", size=2)

T.P1.R <- ggplot(tampico, aes(x=SPP, y=P1.R, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Number of rays  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=P1.R), fun=mean, geom="point", colour= "#29211F", size=2)

T.LLSC <- ggplot(tampico, aes(x=SPP, y=LLSC, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=LLSC), fun=mean, geom="point", colour= "#29211F", size=2)

T.SALL <- ggplot(tampico, aes(x=SPP, y=SALL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SALL), fun=mean, geom="point", colour= "#29211F", size=2)

T.SBLL <- ggplot(tampico, aes(x=SPP, y=SBLL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SBLL), fun=mean, geom="point", colour= "#29211F", size=2)  

T.SBDF <- ggplot(tampico, aes(x=SPP, y=SBDF, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SBDF), fun=mean, geom="point", colour= "#29211F", size=2)

T.BD <- ggplot(tampico, aes(x=SPP, y=BD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=BD), fun=mean, geom="point", colour= "#29211F", size=2)

T.CPD <- ggplot(tampico, aes(x=SPP, y=CPD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=CPD), fun=mean, geom="point", colour= "#29211F", size=2)

T.CPL <- ggplot(tampico, aes(x=SPP, y=CPL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=CPL), fun=mean, geom="point", colour= "#29211F", size=2)

T.PreDL <- ggplot(tampico, aes(x=SPP, y=PreDL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=PreDL), fun=mean, geom="point", colour= "#29211F", size=2)  

T.DbL <- ggplot(tampico, aes(x=SPP, y=DbL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=DbL), fun=mean, geom="point", colour= "#29211F", size=2)

T.HL <- ggplot(tampico, aes(x=SPP, y=HL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HL), fun=mean, geom="point", colour= "#29211F", size=2) 

T.HD <- ggplot(tampico, aes(x=SPP, y=HD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HD), fun=mean, geom="point", colour= "#29211F", size=2)

T.HW <- ggplot(tampico, aes(x=SPP, y=HW, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Width (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HW), fun=mean, geom="point", colour= "#29211F", size=2)

T.SnL <- ggplot(tampico, aes(x=SPP, y=SnL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SnL), fun=mean, geom="point", colour= "#29211F", size=2)

T.OL <- ggplot(tampico, aes(x=SPP, y=OL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=OL), fun=mean, geom="point", colour= "#29211F", size=2)

T.FLA <- ggplot(tampico, aes(x=SPP, y=FLA, color=SPP))  + scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Pectoral ray count difference\n (fluctuating asymmetry)\n") + xlab("\n Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=FLA), fun=mean, geom="point", colour= "#29211F", size=2)



T.D
ggsave(T.D, filename = "T.D.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.P1
ggsave(T.P1, filename = "T.P1.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.A
ggsave(T.A, filename = "T.A.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.P1.R
ggsave(T.P1.R, filename = "T.P1-R.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.LLSC
ggsave(T.LLSC, filename = "T.LLSC.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.SALL
ggsave(T.SALL, filename = "T.SALL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.SBLL
ggsave(T.SBLL, filename = "T.SBLL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.SBDF
ggsave(T.SBDF, filename = "T.SBDF.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.BD
ggsave(T.BD, filename = "T.BD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.CPD
ggsave(T.CPD, filename = "T.CPD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.CPL
ggsave(T.CPL, filename = "T.CPL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.PreDL
ggsave(T.PreDL, filename = "T.PreDL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.DbL
ggsave(T.DbL, filename = "T.DbL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.HL
ggsave(T.HL, filename = "T.HL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.HD
ggsave(T.HD, filename = "T.HD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.HW
ggsave(T.HW, filename = "T.HW.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.SnL
ggsave(T.SnL, filename = "T.SnL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.OL
ggsave(T.OL, filename = "T.OL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
T.FLA
ggsave(T.FLA, filename = "T.FLA.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
```
...
F.D <- ggplot(rawF3, aes(x=SPP, y=D, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)  + theme_classic()+ ylab("Number of rays  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=D), fun=mean, geom="point", colour= "#29211F", size=2)

F.P1 <- ggplot(rawF3, aes(x=SPP, y=P1, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)  + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=P1), fun=mean, geom="point", colour= "#29211F", size=2)

F.A <- ggplot(rawF3, aes(x=SPP, y=A, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)  + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=A), fun=mean, geom="point", colour= "#29211F", size=2)

F.P1.R <- ggplot(rawF3, aes(x=SPP, y=P1.R, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)+ theme_classic()+ ylab("Number of rays  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=P1.R), fun=mean, geom="point", colour= "#29211F", size=2)

F.LLSC <- ggplot(rawF3, aes(x=SPP, y=LLSC, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)  + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=LLSC), fun=mean, geom="point", colour= "#29211F", size=2)

F.SALL <- ggplot(rawF3, aes(x=SPP, y=SALL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)  + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SALL), fun=mean, geom="point", colour= "#29211F", size=2)

F.SBLL <- ggplot(rawF3, aes(x=SPP, y=SBLL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SBLL), fun=mean, geom="point", colour= "#29211F", size=2)  

F.SBDF <- ggplot(rawF3, aes(x=SPP, y=SBDF, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)  + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SBDF), fun=mean, geom="point", colour= "#29211F", size=2)

F.BD <- ggplot(rawF3, aes(x=SPP, y=BD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)+ theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=BD), fun=mean, geom="point", colour= "#29211F", size=2)

F.CPD <- ggplot(rawF3, aes(x=SPP, y=CPD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=CPD), fun=mean, geom="point", colour= "#29211F", size=2)

F.CPL <- ggplot(rawF3, aes(x=SPP, y=CPL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=CPL), fun=mean, geom="point", colour= "#29211F", size=2)

F.PreDL <- ggplot(rawF3, aes(x=SPP, y=PreDL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=PreDL), fun=mean, geom="point", colour= "#29211F", size=2)  

F.DbL <- ggplot(rawF3, aes(x=SPP, y=DbL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=DbL), fun=mean, geom="point", colour= "#29211F", size=2)

F.HL <- ggplot(rawF3, aes(x=SPP, y=HL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Ama zon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HL), fun=mean, geom="point", colour= "#29211F", size=2) 

F.HD <- ggplot(rawF3, aes(x=SPP, y=HD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HD), fun=mean, geom="point", colour= "#29211F", size=2)

F.HW <- ggplot(rawF3, aes(x=SPP, y=HW, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Width (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HW), fun=mean, geom="point", colour= "#29211F", size=2)

F.SnL <- ggplot(rawF3, aes(x=SPP, y=SnL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SnL), fun=mean, geom="point", colour= "#29211F", size=2)

F.OL <- ggplot(rawF3, aes(x=SPP, y=OL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=OL), fun=mean, geom="point", colour= "#29211F", size=2)

F.FLA <- ggplot(rawF3, aes(x=SPP, y=FLA, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.1, height = 0, show.legend = FALSE) + theme_classic()+ ylab("Pectoral ray count difference \n (fluctuating asymmetries)\n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=FLA), fun=mean, geom="point", colour= "#29211F", size=2)
  

F.D
ggsave(F.D, filename = "F.D.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.P1
ggsave(F.P1, filename = "F.P1.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.A
ggsave(F.A, filename = "F.A.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.P1.R
ggsave(F.P1.R, filename = "F.P1-R.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.LLSC
ggsave(F.LLSC, filename = "F.LLSC.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.SALL
ggsave(F.SALL, filename = "F.SALL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.SBLL
ggsave(F.SBLL, filename = "F.SBLL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.SBDF
ggsave(F.SBDF, filename = "F.SBDF.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.BD
ggsave(F.BD, filename = "F.BD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.CPD
ggsave(F.CPD, filename = "F.CPD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.CPL
ggsave(F.CPL, filename = "F.CPL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.PreDL
ggsave(F.PreDL, filename = "F.PreDL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.DbL
ggsave(F.DbL, filename = "F.DbL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.HL
ggsave(F.HL, filename = "F.HL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.HD
ggsave(F.HD, filename = "F.HD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.HW
ggsave(F.HW, filename = "F.HW.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.SnL
ggsave(F.SnL, filename = "F.SnL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.OL
ggsave(F.OL, filename = "F.OL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
F.FLA
ggsave(F.FLA, filename = "F.FLA.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
```
...
TF.D <- ggplot(Ftampico, aes(x=SPP, y=D, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of rays  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=D), fun=mean, geom="point", colour= "#29211F", size=2)

TF.P1 <- ggplot(Ftampico, aes(x=SPP, y=P1, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=P1), fun=mean, geom="point", colour= "#29211F", size=2)

TF.A <- ggplot(Ftampico, aes(x=SPP, y=A, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of rays \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=A), fun=mean, geom="point", colour= "#29211F", size=2)

TF.P1.R <- ggplot(Ftampico, aes(x=SPP, y=P1.R, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)+ theme_classic()+ ylab("Number of rays  \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=P1.R), fun=mean, geom="point", colour= "#29211F", size=2)

TF.LLSC <- ggplot(Ftampico, aes(x=SPP, y=LLSC, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=LLSC), fun=mean, geom="point", colour= "#29211F", size=2)

TF.SALL <- ggplot(Ftampico, aes(x=SPP, y=SALL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SALL), fun=mean, geom="point", colour= "#29211F", size=2)

TF.SBLL <- ggplot(Ftampico, aes(x=SPP, y=SBLL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)+ theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SBLL), fun=mean, geom="point", colour= "#29211F", size=2)  

TF.SBDF <- ggplot(Ftampico, aes(x=SPP, y=SBDF, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Number of scales \n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SBDF), fun=mean, geom="point", colour= "#29211F", size=2)

TF.BD <- ggplot(Ftampico, aes(x=SPP, y=BD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=BD), fun=mean, geom="point", colour= "#29211F", size=2)

TF.CPD <- ggplot(Ftampico, aes(x=SPP, y=CPD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=CPD), fun=mean, geom="point", colour= "#29211F", size=2)

TF.CPL <- ggplot(Ftampico, aes(x=SPP, y=CPL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=CPL), fun=mean, geom="point", colour= "#29211F", size=2)

TF.PreDL <- ggplot(Ftampico, aes(x=SPP, y=PreDL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=PreDL), fun=mean, geom="point", colour= "#29211F", size=2)  

TF.DbL <- ggplot(Ftampico, aes(x=SPP, y=DbL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=DbL), fun=mean, geom="point", colour= "#29211F", size=2)

TF.HL <- ggplot(Ftampico, aes(x=SPP, y=HL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE) + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HL), fun=mean, geom="point", colour= "#29211F", size=2) 

TF.HD <- ggplot(Ftampico, aes(x=SPP, y=HD, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Depth (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HD), fun=mean, geom="point", colour= "#29211F", size=2)

TF.HW <- ggplot(Ftampico, aes(x=SPP, y=HW, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Width (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=HW), fun=mean, geom="point", colour= "#29211F", size=2)

TF.SnL <- ggplot(Ftampico, aes(x=SPP, y=SnL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=SnL), fun=mean, geom="point", colour= "#29211F", size=2)

TF.OL <- ggplot(Ftampico, aes(x=SPP, y=OL, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Length (mm)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=OL), fun=mean, geom="point", colour= "#29211F", size=2)

TF.FLA <- ggplot(Ftampico, aes(x=SPP, y=FLA, color=SPP)) +scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.1, height = 0,show.legend = FALSE)  + theme_classic()+ ylab("Pectoral ray count difference \n (fluctuating asymmetries)\n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=FLA), fun=mean, geom="point", colour= "#29211F", size=2)
  

TF.D
ggsave(TF.D, filename = "TF.D.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.P1
ggsave(TF.P1, filename = "TF.P1.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.A
ggsave(TF.A, filename = "TF.A.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.P1.R
ggsave(TF.P1.R, filename = "TF.P1-R.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.LLSC
ggsave(TF.LLSC, filename = "TF.LLSC.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.SALL
ggsave(TF.SALL, filename = "TF.SALL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.SBLL
ggsave(TF.SBLL, filename = "TF.SBLL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.SBDF
ggsave(TF.SBDF, filename = "TF.SBDF.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.BD
ggsave(TF.BD, filename = "TF.BD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.CPD
ggsave(TF.CPD, filename = "TF.CPD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.CPL
ggsave(TF.CPL, filename = "TF.CPL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.PreDL
ggsave(TF.PreDL, filename = "TF.PreDL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.DbL
ggsave(TF.DbL, filename = "TF.DbL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.HL
ggsave(TF.HL, filename = "TF.HL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.HD
ggsave(TF.HD, filename = "TF.HD.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.HW
ggsave(TF.HW, filename = "TF.HW.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.SnL
ggsave(TF.SnL, filename = "TF.SnL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.OL
ggsave(TF.OL, filename = "TF.OL.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
TF.FLA
ggsave(TF.FLA, filename = "TF.FLA.png", bg="transparent", width = 90, height = 120, units = "mm", dpi = 300)
```
