...
P1.R <- ggplot(raw3, aes(x=SPP, y=abs.res.P1.R, color=SPP)) + scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.05, show.legend = FALSE) +  coord_fixed(ratio = 3) + theme_classic()+ ylab("Number of rays (residals)\n") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=abs.res.P1.R), fun=mean, geom="point", colour= "#29211F", size=2)

ggsave(P1.R, filename = "right-pect.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)
...
CPD <- ggplot(raw3, aes(x=SPP, y=abs.res.CPD, color=SPP)) + scale_color_manual(values = c( "#E1AF00", "#78B7C5")) +
  geom_jitter(alpha=0.2, width=0.05, show.legend = FALSE) +  coord_fixed(ratio = 30) + theme_classic()+ ylab("Depth (log residals)") + xlab("Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=abs.res.CPD), fun=mean, geom="point", colour= "#29211F", size=2)

ggsave(CPD, filename = "cpd.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)
...
T.FLA <- ggplot(tampico, aes(x=SPP, y=FLA, color=SPP))  + scale_color_manual(values = c( "#E1AF00", "#78B7C5", "#9986A5"))+
  geom_jitter(alpha=0.2, width=0.05, show.legend = FALSE) +  coord_fixed(ratio = 2) + theme_classic()+ ylab("Pectoral ray count difference\n (fluctuating asymmetry)\n") + xlab("\n Species")+ scale_x_discrete(labels=c('Amazon\n molly', 'Sailfin\n molly', 'Atlantic\n molly'))  + stat_summary(fun.data = mean_se, geom = "errorbar", colour="#29211F", width=0.1) + stat_summary(aes(x=SPP, y=FLA), fun=mean, geom="point", colour= "#29211F", size=2)

ggsave(T.FLA, filename = "tampico.png", bg="transparent", width = 180, height = 120, units = "mm", dpi = 300)
