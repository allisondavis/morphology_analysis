...
MX.glm_D <- glm(F.abs.res.D~SPP, data=Ftampico)
print(summary(MX.glm_D), show.residuals=TRUE)

MX.glm_P1.R <- glm(F.abs.res.P1.R~SPP, data=Ftampico)
print(summary(MX.glm_P1.R), show.residuals=TRUE)

MX.glm_LLSC <- glm(F.abs.res.LLSC~SPP, data=Ftampico)
print(summary(MX.glm_LLSC), show.residuals=TRUE)

MX.glm_SBLL <- glm(F.abs.res.SBLL~SPP, data=Ftampico)
print(summary(MX.glm_SBLL), show.residuals=TRUE)``
