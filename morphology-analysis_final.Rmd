...
* Not sure how to tell which species is varying more when I do a two-sided. Steve said to just look at the means, but that doesn't make much sense to me (the mean can still be high with very little variation)...maybe I'm missing something? Just to find out, I ran one-sided tests below.

  - Think I need to present residual means instead

```{r}
#right pectoral ray count --sailfins vary more
t.test(abs.lat.P1.R1, abs.form.P1.R1, alternative = "greater")
t.test(abs.lat.P1.R1, abs.form.P1.R1, alternative = "less")


#scales below lateral line--amazons vary more
t.test(abs.lat.SBLL1, abs.form.SBLL1, alternative = "greater")
t.test(abs.lat.SBLL1, abs.form.SBLL1, alternative = "less")


#predorsal length--amazons vary more
t.test(abs.lat.PreDL1, abs.form.PreDL1, alternative = "greater")
t.test(abs.lat.PreDL1, abs.form.PreDL1, alternative = "less")


#dorsal base length--sailfins vary more
t.test(abs.lat.DbL1, abs.form.DbL1, alternative = "greater")
t.test(abs.lat.DbL1, abs.form.DbL1, alternative = "less")
