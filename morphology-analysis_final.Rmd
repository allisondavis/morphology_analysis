...
raw2 <- raw1[complete.cases(raw1[, 9:30]),] #that worked!
...
PCA <- prcomp(raw2[, 9:30], center=TRUE, scale. = TRUE) #includes all 22 traits 
summary(PCA)
...
lat1 <- lat[complete.cases(lat[, 9:30]),]
form1 <- form[complete.cases(form[, 9:30]),]
...
PCA2 <- prcomp(raw4[, 32:47], center=TRUE, scale. = TRUE) #includes all 22 traits 
summary(PCA2)
