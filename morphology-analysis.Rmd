...
In this analysis, I will compare the principle components after centering and scaling the data. A PCA analysis will help us determine what aspects of morphology influence the variation in our data the most without worrying about differences in scales/measurements.
...
ggplot_pca(PCA1, ellipse = TRUE, color= raw.spp, groups = raw.spp)
...
rawPC <- cbind(raw1, PCA1$x[,1:2])

ggplot(rawPC, aes(PC1, PC2, col=SPP, fill=SPP)) +
