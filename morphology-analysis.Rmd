...
colnames(latRM)[28:47] <- c("ZD", "ZP1", "ZA", "ZP1.R", "ZLLSC", "ZSALL", "ZSBLL", "ZSBDF", "ZTL", "ZSL", "ZBD", "ZCPD", "ZCPL", "ZPreDL", "ZDbL", "ZHL", "ZHD", "ZHW", "ZSnL", "ZOL")
latRM
...
colnames(formRM)[28:47] <- c("ZD", "ZP1", "ZA", "ZP1.R", "ZLLSC", "ZSALL", "ZSBLL", "ZSBDF", "ZTL", "ZSL", "ZBD", "ZCPD", "ZCPL", "ZPreDL", "ZDbL", "ZHL", "ZHD", "ZHW", "ZSnL", "ZOL")
formRM
...
#total length
Anova(lm(data = raw, TL ~ SPP * SL), type = "III")
