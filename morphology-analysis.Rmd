...
ggplot(raw2, aes(x=SPP, y=P1.R)) + geom_boxplot() + xlab("Species") + ylab("Ray count") + ggtitle("Right pectorcal ray comparison") + geom_dotplot(binaxis = "y", stackdir = "center", method="histodot",binwidth = 1,  dotsize = 0.08, fill= "black") + theme_classic() + scale_fill_manual(values = c("#9C964A", "#FAD77B")) + theme(text = element_text(size = 16)) + theme(legend.position = "none")
