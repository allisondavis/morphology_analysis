...
form_D <- form3$D
form_P1 <- form3$P1
form_P2.R <- form3$P2.R
form_P2.L <- form3$P2.L
form_A <- form3$A
form_P1.R <- form3$P1.R
form_LLSC <- form3$LLSC
form_SALL <- form3$SALL
form_SBLL <- form3$SBLL
form_SBDF <- form3$SBDF
form_SL <- form3$SL
form_BD <- form3$BD
form_CPD <- form3$CPD
form_CPL <- form3$CPL
form_PreDL <- form3$PreDL
form_DbL <- form3$DbL
form_HL <- form3$HL
form_HD <- form3$HD
form_HW <- form3$HW
