...
**Quick results summary:** traits *not* influenced by body size are; all other traits influenced by body size. 
...
abs.res.D <- append(abs.lat.D, abs.form.D)
abs.res.P1 <- append(abs.lat.P1, abs.form.P1)
abs.res.P1.R <- append(abs.lat.P1.R, abs.form.P1.R)
abs.res.LLSC<- append(abs.lat.LLSC, abs.form.LLSC)
abs.res.SBLL<- append(abs.lat.SBLL, abs.form.SBLL)
abs.res.BD<- append(abs.lat.BD, abs.form.BD)
abs.res.CPD<- append(abs.lat.CPD, abs.form.CPD)
abs.res.CPL<- append(abs.lat.CPL, abs.form.CPL)
abs.res.PreDL <- append(abs.lat.PreDL, abs.form.PreDL)
abs.res.DbL <- append(abs.lat.DbL, abs.form.DbL)
abs.res.HL<- append(abs.lat.HL, abs.form.HL)
abs.res.HD<- append(abs.lat.HD, abs.form.HD)
abs.res.HW <- append(abs.lat.HW, abs.form.HW)
abs.res.SnL <- append(abs.lat.SnL, abs.form.SnL)
abs.res.OL <- append(abs.lat.OL, abs.form.OL)
