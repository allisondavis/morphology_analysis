...
var.PCA.spp <- test.df %>%
  ...
  gt() %>% tab_header(title = "Variation of Pricipal Components 1 & 2") %>%
...
plot1<- autoplot(PCA.test, data = test.df, colour="Species", loadings=FALSE, loadings.label=FALSE, frame=TRUE, frame.type='norm', label= FALSE)+
...
grid.arrange(ba.BD1, ba.BD2, ba.HD1, ba.HD2)
```
...
gtsave(ba.stats.char, "TB9_ba-stats-char.png")
...
gtsave(levene.geo.results, "TB6_levene-geo-results.png")
...
gtsave(post.pca.tbl, "TB10_post-pca-methods.png")
